...
function renderBoard(data, options = {}) {
  ...
  const keys = focus === "tickets"
    ? `${c.dim}\u2191\u2193 move  ${k("n","ext")}  ${k("s","top")}  ${k("d","elete")}  ${k("a","dd")}  ${k("l","og")}  ${c.dim}Enter answer  ${k("r","efresh")}  ${k("q","uit")}`
    : `${c.dim}\u2191\u2193 move  1-9 jump  ${c.dim}Enter answer  ${k("n","ext")}  ${k("s","top")}  ${k("d","elete")}  ${k("a","dd")}  ${k("l","og")}  ${k("r","efresh")}  ${k("q","uit")}`;
  out.push(`  ${keys}`);
