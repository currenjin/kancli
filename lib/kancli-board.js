...
function renderBoard(data, options = {}) {
  ...
  const keys = focus === "tickets"
    ? `${c.dim}\u2191\u2193 move  ${c.white}n${c.dim}ext  ${c.white}s${c.dim}top  ${c.white}d${c.dim}elete  ${c.white}a${c.dim}dd  Enter answer  ${c.white}r${c.dim}efresh  ${c.white}q${c.dim}uit${c.reset}`
    : `${c.dim}\u2191\u2193 move  1-9 jump  Enter answer  ${c.white}n${c.dim}ext  ${c.white}s${c.dim}top  ${c.white}d${c.dim}elete  ${c.white}a${c.dim}dd  ${c.white}r${c.dim}efresh  ${c.white}q${c.dim}uit${c.reset}`;
  out.push(`  ${keys}`);
